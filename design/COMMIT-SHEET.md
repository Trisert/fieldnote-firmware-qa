# COMMIT-SHEET — Fieldnote / firmware QA

## 1. Peak / Signature
The hero evidence sheet: a physical-looking release record that traces one requirement through a test, CI run, and artifact. A visitor should describe the page as “the firmware QA page with the evidence sheet,” not as another SaaS landing page.
...
## 6. Reflex check
- a) Generic embedded QA page: near-black background, mono labels, amber accent, status header, metric strip, repeated cards.
